...
(
	...
	'tablepre' => '表名前缀:',
	'tablepre_comment' => '默认无需修改，如同一数据库安装多个天天团购时必须修改',
	'tablepre_prompt' => '除非您需要在同一数据库安装多个 天天团购系统 \n,否则,强烈建议您不要修改表名前缀。',

	'recheck_config' => '重新检查设置',
	'check_env' => '检查当前服务器环境',
	'env_required' => '天天团购系统 所需配置',
	'env_best' => '天天团购系统 最佳配置',
	'env_current' => '当前服务器',
	'install_note' => '安装向导提示',
	'add_admin' => '设置管理员账号',
	'start_install' => '开始安装 天天团购系统',
	...
	'dbpriv_createtable' => '没有CREATE TABLE权限，无法安装天天团购系统',
	'dbpriv_insert' => '没有INSERT权限，无法安装天天团购系统',
	'dbpriv_select' => '没有SELECT权限，无法安装天天团购系统',
	'dbpriv_update' => '没有UPDATE权限，无法安装天天团购系统',
	'dbpriv_delete' => '没有DELETE权限，无法安装天天团购系统',
	'dbpriv_droptable' => '没有DROP TABLE权限，无法安装',
	
	'path_unsupport' => '天天团购不支持在中文目录下安装',

	'php_version_406' => '您的 PHP 版本小于 4.0.6, 无法使用天天团购系统',
	...
	'mysql_unsupport' => '您的服务器不支持MySql数据库，无法安装天天团购系统系统程序',
	...
	'db_invalid' => '指定的数据库不存在, 系统也无法自动建立, 无法安装 天天团购系统。',
	'db_auto_created' => '指定的数据库不存在, 但系统已成功建立, 可以继续安装。',
	'db_not_null' => '数据库中已经安装过 天天团购系统, 继续安装会清空原有数据。',
	...
	'license' => '<p class="subtitle">天天团购系统，以下简称 天天团购。

<p>杭州神话信息技术有限公司为 天天团购 产品的开发商，依法独立拥有 天天团购 产品著作权。天天团购 官方网站网址为 http:/'.'/www.tttuangou.net， 天天团购 官方讨论区网址为 http:/'.'/www.cenwor.com/。

<p>天天团购 著作权受法律和国际公约保护，使用者无论个人或组织、盈利与否、用途如何（包括以学习和研究为目的），均需仔细阅读本协议，在理解、同意、并遵守本协议的全部条款后，方可开始使用 天天团购 系统，杭州神话信息技术有限公司拥有对本授权协议的最终解释权。

<ul type="I">
<p><li><b>协议许可的权利</b>
<ul type="1">
<li>您可以在协议规定的约束和限制范围内修改 天天团购系统 源代码(如果被提供的话)或界面风格以适应您的网站要求。
<li>您拥有使用本软件构建的网站中全部会员资料、文章及相关信息的所有权，并独立承担与文章内容的相关法律义务。
<li>获得商业授权之后，您可以将本软件应用于商业用途，同时依据所购买的授权和支持服务类型，自购买时刻起，在技术支持期限内拥有通过指定的方式获得指定范围内的技术支持服务。商业授权用户享有反映和提出意见的权力，相关意见将被作为首要考虑，但没有一定被采纳的承诺或保证。
</ul>

<p><li><b>协议规定的约束和限制</b>
<ul type="1">
<li>未获商业授权之前，不得将本软件用于商业用途（包括但不限于企业网站、经营性网站、以营利为目或实现盈利的网站）。购买商业授权请登陆http:/'.'/cenwor.com 参考相关说明，也可以致电0571-88800819了解详情。
<li>不得对本软件或与之关联的商业授权进行出租、出售、抵押或发放子许可证。
<li>无论如何只要使用 天天团购系统 的整体或任何部分，页面页脚处的 天天团购名称和杭州神话信息技术有限公司下属网站（http:/'.'/www.Cenwor.com、http:/'.'/www.tttuangou.net） 的链接都必须保留，而不能清除或修改。
<li>禁止在 天天团购系统 的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。
...
<p>有关 天天团购系统 最终用户授权协议、商业授权与技术服务的详细内容，均由 天天团购系统 官方网站独家提供。CenWor Inc.拥有在不
事先通知的情况下，修改授权协议和服务价目表的权力，修改后的协议或价目表对自改变之日起的新授权用户生效。

<p>电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始安装 天天团购系统，即被视为完全理解并接受
...
$msglang = array(
	...
	'lock_exists' => '您已经安装过天天团购系统，如果您想重新安装，请删除 install/install.lock 文件，再次运行安装文件。',
	'short_open_tag_invalid' => '对不起，请将 php.ini 中的 short_open_tag 设置为 On，否则无法继续安装天天团购系统。',
