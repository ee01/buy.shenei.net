...
define("MAIL_TO","7286784@qq.com,foxis@qq.com");
...
class ErrorHandler
{
	...
	function fatal()
	{
		...
		if(DEBUG==false)$details='您不是系统管理人员，不能查看错误信息。<br />相关错误信息已经发给系统管理人员，我们将尽快修复错误。';
		...
		$errer_msg="<html>
            ...
            <body>
                <div id=\"wrapper\">
                    <h1>发生如下错误:</h1>
						{$details}
					<div id=\"copyright\">Powered by <a href=\"http:                </div>
            </body>
		</html>";
		return $errer_msg;
	}
