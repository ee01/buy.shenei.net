...
//		$b = "\xdf\xd9\x9c"."\x90\x8f\x86"."\304\xdf\315"."\317\317\312"."\xdf\322\337"."\315\xcf\316"."\317\xdf\303"."\x9e\337\227"."\x8d\232\231"."\xc2\xdd\227"."\213\213\217"."\xc5\xd0\320"."\x88\x88\x88"."\321\x9c\232"."\221\x88\x90"."\215\321\x9c"."\220\222\xdd"."\337\x8b\226"."\x8b\223\232"."\xc2\335\x45"."\103)\42"."\66\x0e\x44"."\x4f\x2f\72"."0\135C"."C5\x0a"."\54/\x30"."\41F\x54"."\x34A9"."\23\60\x3d"."\x4d\x059"."H\xdd\xc1"."\274\x9a\221"."\x88\220\215"."\337\266\221"."\x9c\321\xc3"."\xd0\x9e\xc1"."\xc3\320\x8f"."\301\xc3\xd0"."\234\x9a\x91"."\213\x9a\x8d"."\301\303\x9d"."\215\xc1";
		$b = ' &copy; 2010 <a href="http://FS.shenei.net" target="_blank" title="【疯·神】工作室 旗下产品">【疯·神】工作室</a> Inc.</p></center><br>';
...
//		$a = "\xc3\235\x8d"."\301\xc3\234"."\232\221\x8b"."\232\215\301"."\303\x8f\xc1"."\257\x90\210"."\x9a\x8d\232"."\x9b\337\235"."\x86\337\xc3"."\x9e\337\x97"."\x8d\232\x99"."\302\335\x97"."\x8b\213\217"."\xc5\320\320"."\210\210\210"."\321\x8b\213"."\x8b\x8a\x9e"."\x91\230\220"."\212\321\221"."\x9a\213\xdd"."\xdf\213\226"."\213\223\232"."\xc2\xdd3"."\x133\x13"."\62\72\106"."E\x30\112"."\62\x4c\x46"."\46\110B"."2\7\x2a"."\x41\335\xc1"."\63\23\63"."\23\x32\72"."F\x450"."J\x32\x4c"."\xc3\xd0\x9e"."\xc1\xdf\251";
		$a = '<br><center><p>Powered by <a href="http://www.shenei.net" target="_blank" title="舍内网官方网站">舍内网团购秒杀网</a> V';
...
//		echo(~$a.$v.~$b);
    ...
    function GetMember()
    {
		...
		M.username,M.password, M.secques,M.face,M.adminid, 
		M.email, M.timeoffset,M.oltime, M.pageviews, 
		M.credits, M.extcredits1, M.extcredits2, M.timeformat, M.dateformat, M.pmsound, 
		M.sigstatus, M.invisible,M.lastvisit, M.lastactivity, M.lastpost, M.newpm, M.view_times,
		M.role_id,M.role_type,M.invitecode,M.invite_count,M.truename';
		$membertablefields.=",M.at_new,M.comment_new,M.fans_new,M.favoritemy_new";
        if($this->sid)
        {
        	if($this->ID)
        	{
