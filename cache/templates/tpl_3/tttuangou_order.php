...
<div class="nleftL">
<span>（如果在线支付有限额，可先分多次<a href="/myself/addmoney" target=_blank>对账户充值</a>，然后刷新本页使用余额支付） 当前账户余额 <span style="color:#FF0000;"><?=$self['money']?>元</span>，使用余额付款后，</span><span class="SR B R">还应支付金额：&yen; <?=$totalprice2?>元 </span>
</div>
<div class="nleftL">
<form action="<?=$action?>" method="post"  enctype="multipart/form-data">
<input type="hidden" name="FORMHASH" value='<?=FORMHASH?>'/>
<div class="order_check_form ">
<p class="choose_pay_type">请选择支付方式：</p>
...
<? } ?>
">
<a style="margin-left: 1em;" href="/home/buy/editnum-<?=$num?>/id-<?=$id?>">返回修改订单</a> 
</p>
</div>
</form>
</div>
