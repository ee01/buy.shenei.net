...
<li class="ts3_mbtn1"><a href="/myself/money">我的余额</a></li>
...
<div class="nleftL"><span class="B">您当前的帐户余额是 <em class="R"> <?=$money['money']?></em> 元</span> <a href="/myself/addmoney">&lt;点我为账户充值&gt;</a> </div>
<div class="nleftL">
<table id="report">
<tr>
<th>摘要</th>
...
<h3 class="first">什么是帐户余额？</h3>
<p>帐户余额是你在<?=$this->Config['site_name']?>网团购时可用于支付的金额。</p>
<h3>怎样才能有余额？</h3>
<p><a href="/channel/finder">邀请好友</a>获得<?=$this->config['default_payfinder']?> 元返利将充值到帐户余额中。</p>
</div>
</div>
</div>
</div>
