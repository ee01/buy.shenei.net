...
<dt style=" width:65px; float:left;">团购券：</dt>
<dd style="width:365px; float:left; white-space:normal;">
<?=$order['number']?> &nbsp; （密码：<?=$pwd?>）
</dd>
</dl>
<dl>
<dt style=" width:65px; float:left;">特价：</dt>
<dd style="width:365px; float:left; white-space:normal;"><span style="font-size:22px; font-family:"Times New Roman"; color:#FF0000;"><?=$order['nowprice']?></span> 元 / 份 &nbsp; （有效期：<?=$order['perioddate']?>）</dd>
<dd style="width:365px; float:left; white-space:normal;"><span style="font-size:22px; font-family:"Times New Roman"; color:#FF0000;"><?=$order['earnest']?></span> 元定金 &nbsp; （已支付）</dd>
</dl>
<dl>
<dt style=" width:65px; float:left;">地址：</dt>
...
<a href="javascript:printme()" target="_self" style=" font-size:14px;">打印</a> </div>
</div>
</div>
</div>
<div class="t_r">
